...
echo "> [3/8] Creating installation directory at $INSTALLDIR..."
mkdir $INSTALLDIR

echo "> [4/8] Downloading required scripts..."

curl https://github.com/eliblaney/runpi/uninstall.sh > $INSTALLDIR/uninstall.sh
chmod +x $INSTALLDIR/uninstall.sh

curl https://github.com/eliblaney/runpi/runpi.sh > $INSTALLDIR/runpi.sh 
...
curl https://eliblaney.com/raspberrypi/kernel-qemu-4.19.50-buster > $INSTALLDIR/kernel-qemu-4.19.50-buster 

echo "> [7/8] Installing Raspbian [this may take a while]..."
curl https://eliblaney.com/raspberrypi/raspbian-buster.qcow > $INSTALLDIR/raspbian-buster.qcow 

echo "> [8/8] Installing versatile-pb.dtb..."
curl https://eliblaney.com/raspberrypi/versatile-pb.dtb > $INSTALLDIR/versatile-pb.dtb 
